...
public class description_request_tenant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_description_request_tenant);
    Bundle bundle = getIntent().getExtras();
    str = bundle.getString("keyword");
    req = helper.get_Req(str);
    tv = (TextView) findViewById(R.id.text_aptno_tenant);
    // set the text to the variable
    tv.setText("ApartmentNo:   " + req.get_apt_no());

    tv = (TextView) findViewById(R.id.text_room_tenant);
    // set the text to the variable
    tv.setText("Room:   " + req.get_room());

    tv = (TextView) findViewById(R.id.text_type_tenant);
    // set the text to the variable
    tv.setText("Type:   " + req.get_type());

    tv = (TextView) findViewById(R.id.text_descr_tenant);
    // set the text to the variable
    tv.setText("Description:   " + req.get_description());

    tv = (TextView) findViewById(R.id.text_time_time);
    // set the text to the variable
    ...
    if (byteArray == null) {
        ...
        image = (ImageView) findViewById(R.id.display_attachment_tenant);
    ...
    public void onButtonClick(View v) {
        if(v.getId()==R.id.display_attachment_tenant) {
